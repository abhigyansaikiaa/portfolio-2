  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="relative z-20 w-full max-w-[800px] mt-8 md:mt-24 pointer-events-none flex justify-center items-end"
      >
        <img
          src="/abhigyan-cutout.png"
          alt="Abhigyan Saikia"
          className="w-[125vw] md:w-[60vw] lg:w-[45vw] h-[65vh] md:h-[75dvh] object-contain object-bottom drop-shadow-2xl"
        />
      </motion.div>
